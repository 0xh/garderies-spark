<spark-kiosk-users :user="user" inline-template>
    <div>
        <div v-show=" ! showingUserProfile">
            <!-- Search Field card -->
            <div class="card card-default mb-4" style="border: 0;">
                <div class="card-body">
            ...
            <!-- Searching -->
            <div class="card card-default mb-4" v-if="searching">
            ...
            <!-- No Search Results -->
            <div class="card card-default mb-4" v-if=" ! searching && noSearchResults">
                <div class="card-header">{{__('Search Results')}}</div>
            ...
            <!-- User Search Results -->
            <div class="card card-default mb-4" v-if=" ! searching && searchResults.length > 0">
                <div class="card-header">{{__('Search Results')}}</div>
