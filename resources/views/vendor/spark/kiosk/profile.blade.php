                    ...
                    <div class="card card-default mb-4">
                        <div class="card-header">
                            <div class="btn-table-align">
                                <i class="fa fa-btn fa-times mr-2" style="cursor: pointer;" @click="showSearch"></i>
                                @{{ profile.name }}
                            </div>
                        </div>
                        ...
                        <div class="card-footer card-flush text-right">
                            <button class="btn btn-primary btn-sm mr-2" v-if="spark.usesStripe && profile.stripe_id" @click="addDiscount(profile)">
                                {{__('Apply Discount')}}
                            </button>
