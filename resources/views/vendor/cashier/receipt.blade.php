...
<div class="container">
    <table style="margin-left: auto; margin-right: auto" width="550">
        ...
        <tr valign="top">
            ...
            <td>
                <br><br>
                <strong>A :</strong> {{ $owner->email ?: $owner->name }}
                <br>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <p>
                    ...
                    <strong>Numéro de facture:</strong> {{ $id ?? $invoice->id }}<br>
                </p>
                ...
                <table width="100%" class="table" border="0">
                    ...
                    @foreach ($invoice->subscriptions() as $subscription)
                        <tr>
                            <td>Souscription ({{ $subscription->quantity }})</td>
                            <td>
                                {{ $subscription->startDateAsCarbon()->format('d.m.Y') }} -
                                {{ $subscription->endDateAsCarbon()->format('d.m.Y') }}
                            </td>
                    ...
                    @if ($invoice->tax_percent)
                        <tr>
                            <td>Taxe ({{ $invoice->tax_percent }}%)</td>
                            <td>&nbsp;</td>
